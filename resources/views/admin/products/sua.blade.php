                                            ...
                                            <form action="" method="post">
                                                        ...
                                                        <div class="col-lg-9 col-md-6 col-sm-4 col-xs-6">
                                                            <div class="bt-df-checkbox pull-left">
                                                                <select name="product_type">
                                                                    <option value="{{$product->id_type}}">{{$product->product_type->name}}</option>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="promotionprice"  type="number"   class="form-control" value="{{$product->promotion_price}}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="file" class="form-control" name="upload" value="{{$product->image}}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control" name="note" value="{{$product->description}}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
